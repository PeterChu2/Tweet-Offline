...
import chu.ForCHUApps.tweetoffline.db.UserDetailActivity;
...
import chu.ForCHUApps.tweetoffline.util.TwitterListListener;
...
public class TwitterListFragment extends Fragment {
    ...
    private DatabaseOpenHelper.DatabaseName DATABASE_NAME;
    ...
    public void onAttach(Activity activity) {
        ...
        if (sectionNumber == 1) {
            DATABASE_NAME = DatabaseOpenHelper.DatabaseName.FOLLOWING;
        }
        if (sectionNumber == 2) {
            DATABASE_NAME = DatabaseOpenHelper.DatabaseName.FOLLOWERS;
        }
        if (sectionNumber == 3) {
            DATABASE_NAME = DatabaseOpenHelper.DatabaseName.CUSTOM;
        }
        this.database = new DatabaseConnector(activity, DATABASE_NAME);
        multiListener = new TwitterListListener(getActivity(), customAdapter);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        newButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent addNewUser =
                        new Intent(activity, AddEditUserActivity.class);
        ...
        listView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position,
                ...
                Intent viewUser =
                        new Intent(activity, UserDetailActivity.class);
